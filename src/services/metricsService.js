...
async function renderPrometheusMetrics(db) {
  const lines = [
    ...
    "# HELP growth_signal_invites_total Total invite growth signals (sent + accepted)",
    "# TYPE growth_signal_invites_total counter",
    ...renderMetricLines(counters, "growth_signal_invites_total"),
    "# HELP growth_signal_shares_total Total share growth signals",
    "# TYPE growth_signal_shares_total counter",
    ...renderMetricLines(counters, "growth_signal_shares_total"),
    "# HELP retention_signal_returns_total Total session return retention signals",
    "# TYPE retention_signal_returns_total counter",
    ...renderMetricLines(counters, "retention_signal_returns_total"),
    "# HELP engagement_signal_completions_total Total first-30s completion engagement signals",
    "# TYPE engagement_signal_completions_total counter",
    ...renderMetricLines(counters, "engagement_signal_completions_total"),
